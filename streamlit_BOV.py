        ...
        for file in f.namelist():
            ...
            if file.endswith('.xlsx'):
                try:
                    ...
                    star.date = pd.date_range(end=date,periods = 18,freq='M')
                    sub_prop = comps.iloc[0,0]
                    star['STARID'] = sub_prop
                    star_df = star_df.append(star).drop_duplicates()
